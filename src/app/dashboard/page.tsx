                                    ...
                                    <div className="mt-4 border-t border-gray-800 pt-4">
                                        {characterImages[char.id] ? (
                                            <div className="space-y-2">
                                                ...
                                                {/* Approval Checkbox and Delete Button */}
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <button
                                                        onClick={() => deleteImage(characterImages[char.id].id)}
                                                        className="rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-1 text-xs font-medium text-red-400 transition-all hover:border-red-500/50 hover:bg-red-500/20"
                                                        title="Delete image"
                                                    >
                                                        🗑️ Delete
                                                    </button>
